...
class Puggle::PnoValidator < ActiveModel::Validator
  ...
  class << self
    def valid_format_and_checksum?(country_code, pno)
    ...
    def valid_date? (country_code, pno)
    ...
    def extract_date (country_code, pno)
      case country_code
      when 'FI'
